...
abstract class Device {
  ...
  */
   ...
   */
  abstract protected function page_additional();
  ...
  */
  public function render_page() {
    $month = isset($_GET['month']) && $_SESSION['username'] != 'demo' ? $_GET['month'] : 1;
